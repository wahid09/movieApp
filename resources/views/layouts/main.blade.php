...
<body class="font-sans bg-gray-900 text-white">
	<nav class="border-b border-gray-800">
		<div class="container mx-auto px-4 flex-col md:flex-row flex iten-center justify-between py-4 py-6">
		...
		<div class="flex flex-col md:flex-row item-center">
			...
			<div class="md:ml-4 mt-3 md:mt-0">
                    <a href="#">
                        <img src="/img/user.png" alt="avatar" class="rounded-full w-8 h-8">
                    </a>
                </div>
		</div>
		</div>
